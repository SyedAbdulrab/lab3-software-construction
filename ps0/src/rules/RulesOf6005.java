...
public class RulesOf6005 {
	...
	public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
	    ...
	    if (writtenByYourself) {
	        // If the code was written by yourself or your teammates, it can be used.
	        return true;
	    } else if (availableToOthers && writtenAsCourseWork && citingYourSource) {
	        // If the code is available to others, was written as part of a 6.005 assignment,
	        // and you properly cite your source, it can be used.
	        return true;
	    } else if (implementationRequired) {
	        // If the assignment specifically asks you to implement the feature,
	        // the code can be used.
	        return true;
	    } else {
	        // If none of the conditions are met, the code cannot be used.
	        return false;
	    }
	}
    /**
